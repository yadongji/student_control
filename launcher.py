...
def main():
    ...
    tk.Button(box, text="教室同学管理系统", font=("Microsoft YaHei UI", 17, "bold"), height=3, bg="#55b96b", fg="white", activebackground="#3f9a53", command=lambda: run_app("classroom")).pack(fill="x", pady=10)
